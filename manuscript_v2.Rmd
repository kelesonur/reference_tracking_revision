...
```{r model-camera, fig.cap="Regression model plot for the RE Type (Nominal, Null) with the predictors Discourse Status (Introduction, Maintenance, Re-introduction) and Participant Group (Native, Late)", fig.height=3.5, fig.pos="hbt!", fig.width=4, echo=FALSE, message=FALSE, cache=FALSE, results='asis', warnings=FALSE}
