...
@ref\{fig:model-gram\}\footnote{We ran another model where we used the
  ...
  7-above:Late2. However, our model did not converge properly and the
  credible intervals were very wide spread, yielding the results
...
Nominative, and Null. Classifier response is the level that other
responses Nominative and Null are compared against.
